...
const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    SCHEDULES: {
      LIST: '/api/schedules',
      BY_USER: '/api/schedules/user',
      CREATE: '/api/schedules',
      BY_ID: (id) => `/api/schedules/${id}`,
      DELETE: (id) => `/api/schedules/${id}`,
      UPLOAD: '/api/schedules/upload',
      ANALYZE: (id) => `/api/services/analyser-pdf/${id}`,
    },
    TASKS: {
      CREATE: '/api/tasks',
      BY_SUBJECT: (id) => `/api/tasks/matiere/${id}`,
    ...
    PLANNING: {
      ...
      BY_USER: '/api/planning/user',
      UPDATE: (id) => `/api/planning/${id}`,
    },
    STATS: {
      BY_USER: '/api/stats/user',
      BY_SUBJECT: (id) => `/api/stats/subject/${id}`,
    },
  },
};
